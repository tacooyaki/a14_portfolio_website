        ...
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let i of bu(t))
            !wu.call(e, i) &&
              ...
              Ir(e, i, {
                get: () => t[i],
                enumerable: !(n = vu(t, i)) || n.enumerable,
              });
        return e;
      };
    var Eu = (e, t, r) => (
        ...
        return (function (t) {
          ...
          function (t, r, n) {
            ...
            var i = {
              ...
              easeInOutCirc: function (o, a, s, u) {
                var l = s - a;
                return (o /= u / 2) < 1
                  ? (-l / 2) * (Math.sqrt(1 - o * o) - 1) + a
                  : (l / 2) * (Math.sqrt(1 - (o -= 2) * o) + 1) + a;
              },
                  ...
                  o === 0
                    ...
                    : (o /= u) == 1
                      ...
                      : ((c = 0) || (c = 0.3 * u),
                        (l = d) < Math.abs(d)
                          ? ((l = d), (p = c / 4))
                          : (p = (c / (2 * Math.PI)) * Math.asin(d / l)),
                        -l *
                          Math.pow(2, 10 * (o -= 1)) *
                          Math.sin(((o * u - p) * (2 * Math.PI)) / c) +
                          a)
                );
              },
                ...
                return (o /= u) < 0.36363636363636365
                  ...
                  : o < 0.7272727272727273
                    ...
                    : o < 0.9090909090909091
                      ? l * (7.5625 * (o -= 0.8181818181818182) * o + 0.9375) +
                        a
                      : l *
              ...
              easeInOutBounce: function (o, a, s, u) {
                var l = s - a;
                return o < u / 2
                  ? 0.5 * i.easeInBounce(2 * o, 0, l, u) + a
                  : 0.5 * i.easeOutBounce(2 * o - u, 0, l, u) + 0.5 * l + a;
              },
            };
            t.exports = i;
          },
          ...
          function (t, r, n) {
            ...
            (function (g) {
              ...
              (function (g) {
                (g[(g.Positive = 1)] = 'Positive'),
                  (g[(g.Negative = -1)] = 'Negative');
              })(o || (o = {}));
            var h = (function () {
              function g(M, k, R, C) {
                (function (bn, Yt) {
                ...
                (this.context = M),
                  ...
                  (this.radius = c(5, 10)),
                  (this.vx =
                    typeof Se == 'number' ? c(-Se, Se) : c(Se.min, Se.max)),
                  (this.vy =
                    typeof At == 'number' ? c(-At, 0) : c(At.min, At.max)),
                  (this.shape =
                    ((G = 0),
                    (K = 2),
                    Math.floor(G + Math.random() * (K - G + 1)))),
            ...
            var v = function g(w, E) {
              ...
              (function (k, R) {
                ...
                f(this, 'animate', function () {
                  ...
                  if (Gt < Se) {
                    G !== Se &&
                      ((T.tweenInitTime = wn), (T.lastNumberOfPieces = Se));
                    for (
                    ...
                    T.particles.forEach(function (Xt, ei) {
                      Xt.update(),
                        (Xt.y > k.height ||
                          ...
                          Xt.x < -100) &&
                          (rt && Gt <= Se
                            ? (T.particles[ei] = T.getParticle())
                            : T.removeParticleAt(ei));
                    }),
                    xn > 0 || Gt < Se
                  );
                }),
                ...
                function g(M, k) {
                  ...
                  (function (G, K) {
                    ...
                    y(this, 'setOptionsWithDefaults', function (G) {
                      ...
                      (R._options = x(x(x({}, K), P), G)),
                        Object.assign(R, G.confettiSource);
                    }),
                    y(this, 'update', function () {
                      ...
                      K &&
                        ((Se.fillStyle = 'white'),
                        Se.clearRect(0, 0, rt.width, rt.height)),
                        R.generator.animate()
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function ce(g, w) {
              return (
                ...
                (function (E, T) {
                  if (
                    !(typeof Symbol > 'u' || !(Symbol.iterator in Object(E)))
                  ) {
                    var M = [],
                      k = !0,
                      R = !1,
                    ...
                    try {
                      for (
                        var G, K = E[Symbol.iterator]();
                        !(k = (G = K.next()).done) &&
                        (M.push(G.value), !T || M.length !== T);
                        k = !0
                      );
                    } catch (pe) {
                      (R = !0), (C = pe);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function ge(g, w) {
              return !w || (B(w) !== 'object' && typeof w != 'function')
                ? Ee(g)
                : w;
            }
            function Ee(g) {
            ...
            Z(D, 'defaultProps', te({}, P)),
              Z(D, 'displayName', 'ReactConfetti');
    ...
    function Si(e, t, r) {
      ...
      return (
        N.undefined(n) || (l = l && u === n),
        N.undefined(o) || (l = l && s === o),
        l
      );
    }
    function Pi(e, t, r) {
    ...
    function Oi(e, t, { key: r } = {}) {
      ...
      return (
        [n, i].every(N.plainObject) &&
          ((n = Object.keys(n)), (i = Object.keys(i))),
        [n, i]
      );
    }
    function Ci(e) {
    ...
    function Ai(e) {
      return (t) =>
        N.array(e)
          ? e.some((r) => Oe(r, t) || (N.array(t) && bo(t)(r)))
          : Oe(e, t);
    }
    function $t(e, t) {
    ...
    function ms(...e) {
      return (
        e.every(N.array) ||
        e.every(N.number) ||
        e.every(N.plainObject) ||
        e.every(N.string)
      );
    }
    function Ye(e, t) {
      return N.plainObject(e) || N.array(e)
        ? N.string(t)
    ...
    function Xr(e, t) {
      if ([e, t].some(N.nullOrUndefined))
        throw new Error('Missing required parameters');
      if (![e, t].every((r) => N.plainObject(r) || N.array(r)))
      ...
      return {
        ...
        changed: (r, n, i) => {
          try {
            ...
            return [o, a].every(N.array) || [o, a].every(N.plainObject)
              ? !Oe(o, a)
              : o !== a;
          } catch {
            return !1;
    ...
    function Nt(e) {
      ...
      for (
        var t = Ht(10) ? document.body : null, r = e.offsetParent || null;
    ...
    function Ts(e) {
      ...
      for (var t = e.parentElement; t && Ot(t, 'transform') === 'none'; )
        t = t.parentElement;
    ...
    function Is(e, t, r, n) {
      ...
      o.addEventListener(t, r, { passive: !0 }),
        i || Is(vr(o.parentNode), t, r, n),
        n.push(o);
    }
    function Fc(e, t, r, n) {
      (r.updateBound = n),
        Rs(e).addEventListener('resize', r.updateBound, { passive: !0 });
      var i = vr(e);
      return (
        Is(i, 'scroll', r.updateBound, r.scrollParents),
        (r.scrollElement = i),
        (r.eventsEnabled = !0),
        r
      );
    ...
    function _c() {
      this.state.eventsEnabled &&
        ...
        (this.state = zc(this.reference, this.state)));
    }
    function So(e) {
    ...
    function Wc(e, t, r, n, i) {
      ...
      return (
        ...
        $n(t, { position: r.positionFixed ? 'fixed' : 'absolute' }),
        r
      );
    }
    function qc(e, t) {
    ...
    function Gc(e, t) {
      ...
      if (
        (p === 'bottom'
          ? s.nodeName === 'HTML'
            ? (v = -s.clientHeight + c.bottom)
            : (v = -u.height + c.bottom)
          : (v = c.top),
        d === 'right'
          ? s.nodeName === 'HTML'
            ? (f = -s.clientWidth + c.right)
            : (f = -u.width + c.right)
          : (f = c.left),
        a && h)
      )
        (l[h] = 'translate3d(' + f + 'px, ' + v + 'px, 0)'),
          (l[p] = 0),
          (l[d] = 0),
    ...
    function Xc(e, t) {
      ...
      return (
        ...
        (e.arrowElement = n),
        (e.offsets.arrow =
          ((r = {}), Ft(r, p, Math.round(y)), Ft(r, d, ''), r)),
        e
      );
    }
    function Kc(e) {
    ...
    function Jc(e) {
      var t = e.offsets,
        ...
        l = a ? 'width' : 'height';
      return (
        r[s] < o(n[u]) && (e.offsets.popper[u] = o(n[u]) - r[l]),
        r[u] > o(n[s]) && (e.offsets.popper[u] = o(n[s])),
        e
      );
    }
    function Zc(e, t, r, n) {
    ...
    function op(e) {
      ...
      return (
        (i[a ? 'left' : 'top'] = o[r] - (s ? i[a ? 'width' : 'height'] : 0)),
        (e.placement = Qr(t)),
    ...
    function Vi(e, t, r) {
      ...
      return (
        F.undefined(n) || (l = l && u === n),
        F.undefined(o) || (l = l && s === o),
        l
      );
    }
    function Fi(e, t, r) {
      ...
      var r = function (p, d) {
        ...
        n = function (p, d, h) {
          try {
            ...
            return [f, v].every(F.array) || [f, v].every(F.plainObject)
              ? !Ce(f, v)
              : f !== v;
          } catch {
            return !1;
    ...
    function Wi(e, t, r) {
      return (
        ...
        function (n, i, o) {
          for (
            var a = arguments.length, s = new Array(a > 3 ? a - 3 : 0), u = 3;
            u < a;
            u++
          )
            s[u - 3] = arguments[u];
      ...
      a &&
        ...
        Array.isArray(r)
          ? r.forEach(function (u) {
              F.plainObject(u) && u.key
                ? s.apply(console, [u.key, u.value])
                : s.apply(console, [u]);
            })
          : s.apply(console, [r]),
        console.groupEnd());
    ...
    function zs(e) {
      ...
      return (
        ...
        (a || o) &&
          !F.boolean(i) &&
          (l.close = m.createElement(Bs, { styles: u.close, handleClick: n })),
        m.createElement(
          'div',
          { className: '__floater__container', style: u.container },
          l.close,
          l.title,
          l.content,
          l.footer,
    ...
    function dn(e, t, r) {
      ...
      if (n) {
        ...
        if (!(n.scrollHeight > n.offsetHeight) && !t)
          return (n.style.overflow = 'initial'), Et();
      }
      return n;
    }
    function Sr(e, t) {
    ...
    function Kp(e, t, r) {
      ...
      return (
        o instanceof HTMLElement &&
          ((s = o.scrollTop),
          !a && !hr(e) && (u += s),
          o.isSameNode(Et()) || (u += Et().scrollTop)),
        Math.floor(u - t)
      );
    }
    function Qp(e, t, r) {
    ...
    function Zp(e, t) {
      return !N.plainObject(e) || !N.array(t)
        ? !1
        ...
        d = {
          ...
          floaterStyles: {
            arrow: {
              color:
                (o =
                  (i = (n = a?.styles) == null ? void 0 : n.arrow) == null
                    ? void 0
                    : i.color) != null
                  ? o
                  : l.arrowColor,
    ...
    function or(e, t) {
      var r, n, i, o, a, s;
      let u = e ?? {},
        l = Nr.default.all([rd, ad(t), u], {
          isMergeableObject: N.plainObject,
        }),
        c = id(t, l),
        p = Sr(ut(l.target), l.disableScrollParentFix),
        d = Nr.default.all([
          td,
          (r = t.floaterProps) != null ? r : {},
    ...
    function yd(e) {
      ...
      return (
        n &&
          ((H.primary = o ? W : B),
          S &&
            (H.primary = J('span', null, H.primary, ' (', i + 1, '/', s, ')'))),
        x &&
          !o &&
          (H.skip = J(
            'button',
    ...
    function Td({ targetSelector: e }) {
      ...
      `,
            ...
            (n.id = 'sb-onboarding-pulsating-effect'),
              (n.innerHTML = r),
    ...
    function ch(e) {
      ...
      let [d, h, f] = Ke(() => {
        let b = () => {
          ...
          u.current.element instanceof HTMLElement &&
            i &&
            ((ce.height = u.current.element.offsetHeight),
            (ce.width = u.current.element.offsetWidth)),
            Object.freeze(ce),
            p.current &&
              !fh(u.current.lastBounds, ce) &&
              s((u.current.lastBounds = ce));
        };
        return [
          b,
          c ? (0, Ji.default)(b, c) : b,
          l ? (0, Ji.default)(b, l) : b,
        ];
      }, [s, i, l, c]);
      function v() {
      ...
      let x = (b) => {
        !b ||
          ...
          (v(),
          (u.current.element = b),
          (u.current.scrollContainers = Qs(b)),
          S());
      };
      return (
        dh(f, !!r),
    ...
    function dh(e, t) {
      de(() => {
        if (t) {
          let r = e;
          return (
            window.addEventListener('scroll', r, { capture: !0, passive: !0 }),
    ...
    function Qs(e) {
      ...
      return (
        [r, n, i].some((o) => o === 'auto' || o === 'scroll') && t.push(e),
        [...t, ...Qs(e.parentElement)]
      );
    }
    function yh(e) {
      let t = new Zi(),
        ...
        s = {
          ...
          process: (u) => {
            ...
            if (
              ((i = !0), ([t, r] = [r, t]), r.clear(), (n = t.order.length), n)
            )
              for (let l = 0; l < n; l++) {
                let c = t.order[l];
    ...
    function tl(e, t) {
      let r = !1,
        ...
        s = () => {
          ...
          (r = !1),
            (i.delta = n
              ? 1e3 / 60
              : Math.max(Math.min(l - i.timestamp, vh), 1)),
            (i.timestamp = l),
            (i.isProcessing = !0),
            Br.forEach(a),
            (i.isProcessing = !1),
      ...
      return {
        schedule: Br.reduce((l, c) => {
          let p = o[c];
          return (
            (l[c] = (d, h = !1, f = !1) => (r || u(), p.schedule(d, h, f))), l
          );
        }, {}),
    ...
    function wh(e, t) {
      if (gn(e)) {
        ...
        return {
          initial: r === !1 || fr(r) ? r : void 0,
          animate: fr(n) ? n : void 0,
        };
      }
    ...
    function Lo(e, t, r, n) {
      ...
      if (
        (t.transform ||
          (u || n
            ? (i.transform = Mh(e.transform, r, c, n))
    ...
    function zh({ transformTemplate: e }, t, r) {
      return Ke(() => {
        let n = jo();
        return (
          Lo(n, t, { enableHardwareAcceleration: !r }, e),
    ...
    function Fo(e, t) {
      let { style: r } = e,
        n = {};
      for (let i in r)
        (Ae(r[i]) || (t.style && Ae(t.style[i])) || il(i, e)) && (n[i] = r[i]);
      return n;
    }
    function ml(e, t) {
      let r = Fo(e, t);
    ...
    function ff({ root: e, ...t }) {
      ...
      let n = _n.get(r),
        i = JSON.stringify(t);
      return (
        n[i] || (n[i] = new IntersectionObserver(hf, { root: e, ...t })), n[i]
      );
    }
    function mf(e, t, r) {
      let n = ff(t);
    ...
    function Cf(e, t, r, n, i) {
      let o,
        ...
        s = 0;
      do
        (a = t + (r - t) / 2), (o = Cl(a, n, i) - e), o > 0 ? (r = a) : (t = a);
    ...
    function Bf(e) {
      ...
      return (
        isNaN(e) &&
        Or(e) &&
        (((t = e.match(Do)) === null || t === void 0 ? void 0 : t.length) ||
          0) +
          (((r = e.match(Nh)) === null || r === void 0 ? void 0 : r.length) ||
            0) >
          0
      );
    }
    ...
    function qf(e, t) {
      let r = { ...e, ...t },
        n = {};
      for (let i in r)
        e[i] !== void 0 && t[i] !== void 0 && (n[i] = Uo(e[i])(e[i], t[i]));
      return (i) => {
    ...
    function Hl({ keyframes: e, restDelta: t, restSpeed: r, ...n }) {
      ...
      if (f < 1) {
        ...
        b = (P) => {
          ...
          return (
            o -
            O * (((h + f * S * v) / y) * Math.sin(y * P) + v * Math.cos(y * P))
          );
        };
      } else if (f === 1)
        b = (y) => o - Math.exp(-S * y) * (v + (h + S * v) * y);
      else {
        ...
        b = (P) => {
          ...
          return (
            o -
            (O * ((h + f * S * v) * Math.sinh(W) + y * v * Math.cosh(W))) / y
          );
        };
      }
      return {
    ...
    function ma({
      ...
      let p = e[0],
        ...
        f = (z) =>
          s === void 0
            ? u
            : u === void 0 || Math.abs(s - z) < Math.abs(u - z)
              ? s
              : u,
        v = r * t,
        S = p + v,
      ...
      return (
        B(0),
        {
          ...
          next: (z) => {
            let H = !1;
            return (
              !W && O === void 0 && ((H = !0), P(z), B(z)),
              O !== void 0 && z > O ? W.next(z - O) : (!H && P(z), d)
            );
          },
        }
      );
    ...
    function on({
      ...
      let ue = 0,
        re = (Z) => {
          if (H === null) return;
          h > 0 && (H = Math.min(H, Z)),
            h < 0 && (H = Math.min(Z - ye / h, H)),
            z !== null ? (ue = z) : (ue = Math.round(Z - H) * h);
          let A = ue - t * (h >= 0 ? 1 : -1),
            D = h >= 0 ? A < 0 : A > ye;
    ...
    function bm(e, t, { onUpdate: r, onComplete: n, ...i }) {
      ...
      if (vm(t, i)) {
        let x = on({ ...i, repeat: 0, delay: 0 }),
          ...
          P = 0;
        for (; !b.done && P < ym; )
          (b = x.sample(P)), y.push(b.value), (P += _r);
        (h = void 0), (c = y), (p = P - _r), (d = 'linear');
      }
      let f = Ef(e.owner.current, t, c, {
          ...i,
          duration: p,
          ease: d,
          times: h,
    ...
    function xm({ keyframes: e, delay: t, onUpdate: r, onComplete: n }) {
      ...
      return t
        ? on({ keyframes: [0, 1], duration: 0, delay: t, onComplete: i })
        : i();
    }
    function Cm(e) {
        ...
        for (let s = 0; s < a; s++) {
          ...
          Array.isArray(l) && (c = l[0]),
            c === null &&
              (c =
                (i =
                  (n = r[u]) !== null && n !== void 0 ? n : e.readValue(u)) !==
                  null && i !== void 0
                  ? i
                  : t[u]),
            c != null &&
              (typeof c == 'string' && (ql(c) || Wl(c))
                ? (c = parseFloat(c))
                : !Vm(c) && ft.test(l) && (c = Ul(u, l)),
    ...
    function Xl(e, t, { delay: r = 0, transitionOverride: n, type: i } = {}) {
      ...
      for (let p in s) {
        ...
        if (
          (f.type === 'spring' && (d.getVelocity() || f.velocity) && (v = !1),
          d.animation && (v = !1),
          v)
        )
          continue;
    ...
    function Qm(e) {
      return (t) =>
        Promise.all(t.map(({ animation: r, options: n }) => Gm(e, r, n)));
    }
    function Jm(e) {
      let t = Qm(e),
        r = $m(),
      ...
      function a(u, l) {
        ...
        for (let x = 0; x < Km; x++) {
          ...
          let { prevResolvedValues: Te = {} } = y,
            ...
            ue = (re) => {
              (z = !0),
                h.has(re) && ((H = !0), h.delete(re)),
                (y.needsAnimating[re] = !0);
            };
          for (let re in ye) {
            let me = ce[re],
              ke = Te[re];
    ...
    function ag(e, t) {
      ...
      let r = e.length - 1,
        n = null,
        i = Ql(e);
      for (; r >= 0 && ((n = e[r]), !(i.timestamp - n.timestamp > ct(t))); )
        r--;
      if (!n) return { x: 0, y: 0 };
    ...
    function pr(e, t, r, n) {
      wa(e.x, t.x, r.x, n ? n.originX : void 0),
        wa(e.y, t.y, r.y, n ? n.originY : void 0);
    }
    function Ta(e, t, r) {
    ...
    function pg(e, t) {
      ...
      return (
        i > n
          ? (r = gr(t.min, t.max - n, e.min))
          : n > i && (r = gr(e.min, e.max - i, t.min)),
        ht(0, 1, r)
      );
    }
    function dg(e, t) {
      ...
      for (let s = 0; s < i; s++) {
        ...
        (u && u.style && u.style.display === 'contents') ||
          (n &&
            ...
            o.scroll &&
            o !== o.root &&
            jt(e, { x: -o.scroll.offset.x, y: -o.scroll.offset.y }),
    ...
    function ru(e) {
      let [t, r] = Pg(),
        n = be(nl);
      return m.createElement(Cg, {
        ...e,
        layoutGroup: n,
        switchLayoutGroup: be(ol),
        isPresent: t,
        safeToRemove: r,
      });
    }
    function Ig(e, t, r, n, i, o) {
      ...
      for (let a = 0; a < Rg; a++) {
        ...
        (u === void 0 && l === void 0) ||
          ...
          l || (l = 0),
          u === 0 || l === 0 || Va(u) === Va(l)
            ? ((e[s] = Math.max(se(Na(u), Na(l), n), 0)),
              (Xe.test(l) || Xe.test(u)) && (e[s] += '%'))
            : (e[s] = l));
      }
      (t.rotate || r.rotate) &&
        (e.rotate = se(t.rotate || 0, r.rotate || 0, n));
    }
    function Fa(e, t) {
    ...
    function Dg(e, t = 0, r = 1, n = 0.5, i, o = e, a = e) {
      ...
      e === o && (s -= t),
        (e.min = za(e.min, t, r, s, i)),
        (e.max = za(e.max, t, r, s, i));
    }
    function _a(e, t, [r, n, i], o, a) {
      Dg(e, t[r], t[n], t[i], t.scale, o, a);
    }
    function Ha(e, t, r, n) {
      _a(e.x, t, Lg, r ? r.x : void 0, n ? n.x : void 0),
        _a(e.y, t, jg, r ? r.y : void 0, n ? n.y : void 0);
    }
    function Ua(e) {
    ...
    function su({
      ...
      return class {
        ...
        addEventListener(o, a) {
          return (
            this.eventHandlers.has(o) || this.eventHandlers.set(o, new Ko()),
            ...
            e(o, () => {
              (this.root.updateBlockedByResize = !0),
                ...
                Gr.hasAnimatedSinceResize &&
                  ((Gr.hasAnimatedSinceResize = !1), this.nodes.forEach(Ka));
            });
          }
            ...
            this.options.animate !== !1 &&
              ...
              this.addEventListener(
                ...
                ({
                  ...
                  let f =
                      this.options.transition || l.getDefaultTransition() || iy,
                    {
        ...
        startUpdate() {
          this.isUpdateBlocked() ||
            ((this.isUpdating = !0),
            this.nodes && this.nodes.forEach(ty),
            this.animationId++);
        }
        ...
        didUpdate() {
          this.updateScheduled ||
            ((this.updateScheduled = !0), Ro.read(() => this.update()));
        }
        clearAllSnapshots() {
        ...
        applyTransform(o, a = !1) {
          ...
          for (let u = 0; u < this.path.length; u++) {
            ...
            !a &&
              ...
              l.scroll &&
              l !== l.root &&
              jt(s, { x: -l.scroll.offset.x, y: -l.scroll.offset.y }),
        ...
        scheduleRender(o = !0) {
          if (
            (this.options.scheduleRender && this.options.scheduleRender(), o)
          ) {
            let a = this.getStack();
            a && a.scheduleRender();
          }
          ...
          (this.mixTargetDelta = (y) => {
            ...
            Qa(c.x, o.x, P),
              ...
              this.relativeTarget &&
                ...
                b &&
                  Ng(this.relativeTarget, b) &&
                  (this.isProjectionDirty = !1),
                b || (b = he()),
                Me(b, this.relativeTarget)),
              f &&
                ((this.animationValues = l),
                Ig(l, u, this.latestValues, P, x, S)),
              this.root.scheduleUpdateProjection(),
              this.scheduleRender(),
        ...
        finishAnimation() {
          this.currentAnimation &&
            (this.mixTargetDelta && this.mixTargetDelta(Ga),
        ...
        applyTransformsToTarget() {
          ...
          if (!(!a || !s || !u)) {
            if (
              ...
              this.layout &&
              u &&
              lu(this.options.animationType, this.layout.layoutBox, u.layoutBox)
            ) {
              s = this.target || he();
            ...
            Me(a, s),
              jt(a, l),
              pr(this.projectionDeltaWithTransform, this.layoutCorrected, a, l);
          }
        }
        ...
        getProjectionStyles(o) {
          ...
          return (
            this.options.layoutId &&
              (u.pointerEvents =
                c === this ? qr(o?.pointerEvents) || '' : 'none'),
            u
          );
        }
        clearSnapshot() {
            ...
            Le((p) => {
              ...
              (d.max = d.min + h),
                e.relativeTarget &&
                  ...
                  (e.relativeTarget[p].max = e.relativeTarget[p].min + h));
            });
        let s = Lt();
        pr(s, n, r.layoutBox);
        let u = Lt();
        a
          ? pr(u, e.applyTransform(i, !0), r.measuredBox)
          : pr(u, n, r.layoutBox);
        let l = !iu(s),
          c = !1;
        if (!e.resumeFrom) {
    ...
    function Qa(e, t, r) {
      (e.translate = se(t.translate, 0, r)),
        (e.scale = se(t.scale, 1, r)),
        (e.origin = t.origin),
    ...
    function lu(e, t, r) {
      return (
        e === 'position' || (e === 'preserve-aspect' && !co(Wa(t), Wa(r), 0.2))
      );
    }
    function cy(e) {
      let t = uy.exec(e);
    ...
    function Yy() {
      ...
      return (
        de(() => {
          (async () => {
            try {
              let r = (await (await fetch('/index.json')).json()).entries[
      ...
      mu = Ne(() => {
        ...
        (Hu = Object.create),
          ...
          (Ie = (e, t) =>
            function () {
              return (
                t || (0, e[yo(e)[0]])((t = { exports: {} }).exports, t),
                t.exports
              );
            }),
          (Yu = (e, t) => {
          ...
          (vo = Ie({
            '../../node_modules/deepmerge/dist/cjs.js'(e, t) {
              ...
              function l(y, P) {
                return P.clone !== !1 && P.isMergeableObject(y)
                  ? x(u(y), y, P)
                  : y;
              }
              function c(y, P, O) {
              ...
              function v(y, P) {
                return (
                  ...
                  !(
                    ...
                    Object.propertyIsEnumerable.call(y, P)
                  )
                );
              }
              function S(y, P, O) {
            ...
            '../../node_modules/prop-types/factoryWithTypeCheckers.js'(e, t) {
              ...
              t.exports = function (l, c) {
                ...
                function H(A) {
                  ...
                  function D(q, Y, g, w, E) {
                    for (var T = q[Y], M = 0; M < A.length; M++)
                      if (S(T, A[M])) return null;
                ...
                function ce(A) {
                  ...
                  function Y(g, w, E, T, M) {
                    for (var k = [], R = 0; R < A.length; R++) {
                      ...
                      G.data &&
                        o(G.data, 'expectedType') &&
                        k.push(G.data.expectedType);
                    }
                    var K =
                      k.length > 0
                ...
                function re(A) {
                  function D(q, Y, g, w, E) {
                    ...
                    for (var R in k) {
                      var C = A[R];
                      if (o(A, R) && typeof C != 'function')
                        return ye(g, w, E, R, Ee(C));
                      if (!C)
                        return new x(
                          'Invalid ' +
                            w +
...
Valid keys: ` +
            ...
            '../../node_modules/debounce/index.js'(e, t) {
              function r(n, i, o) {
                ...
                function p() {
                  ...
                  h < i && h >= 0
                    ? (a = setTimeout(p, i - h))
                    : ((a = null), o || ((c = n.apply(u, s)), (u = s = null)));
                }
                var d = function () {
        ...
        L.arrayOf = (e, t) =>
          !L.array(e) && !L.function(t) ? !1 : e.every((r) => t(r));
        ...
        L.generator = (e) =>
          L.iterable(e) && L.function(e.next) && L.function(e.throw);
        L.generatorFunction = Be('GeneratorFunction');
        L.instanceOf = (e, t) =>
          !e || !t ? !1 : Object.getPrototypeOf(e) === t.prototype;
        L.iterable = (e) =>
          !L.nullOrUndefined(e) && L.function(e[Symbol.iterator]);
        L.map = Be('Map');
        ...
        L.numericString = (e) =>
          L.string(e) && e.length > 0 && !Number.isNaN(Number(e));
        L.object = (e) =>
          !L.nullOrUndefined(e) && (L.function(e) || typeof e == 'object');
        ...
        (Ri = yr && !!(window.MSInputMethodContext && document.documentMode)),
          (Ii = yr && /MSIE 10/.test(navigator.userAgent));
        (kc = function (e, t) {
          if (!(e instanceof t))
            throw new TypeError('Cannot call a class as a function');
        }),
          ...
          (cn = (function () {
            function e(t, r) {
              ...
              kc(this, e),
                ...
                Object.keys(je({}, e.Defaults.modifiers, i.modifiers)).forEach(
                  function (a) {
        ...
        j.object = function (e) {
          return (
            !j.nullOrUndefined(e) && (j.function(e) || typeof e == 'object')
          );
        };
            ...
            wr(r, [
              {
                ...
                value: function () {
                  qe() &&
                    (this.node || this.appendNode(), tr || this.renderPortal());
                },
              },
              {
                key: 'componentDidUpdate',
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var n = this.props,
                    i = n.children,
                    o = n.setRef;
                  if ((this.node || this.appendNode(), tr))
                    return yt.createPortal(i, this.node);
                      ...
                      (a.startsWith('top')
                        ...
                        : a.startsWith('bottom')
                          ...
                          : a.startsWith('left')
                            ...
                            : a.startsWith('right') &&
                              (x.padding = '0 0 0 '.concat(c, 'px'))),
                    [$.OPENING, $.OPEN].indexOf(u) !== -1 &&
                      (x = ne(ne({}, x), f)),
              ...
              wr(r, [
                ...
                },
                {
                  ...
                  value: function (n, i) {
                    if (qe()) {
                      ...
                      if (n.open !== s) {
                        var h;
                        F.boolean(s) && (h = s ? $.OPENING : $.CLOSING),
                          this.toggle(h);
                      }
                    ...
                    if (p === 'center') this.setState({ status: $.IDLE });
                      ...
                      new Li(i, this.floaterRef, {
                        ...
                        onUpdate: function (P) {
                          ...
                          n._isMounted &&
                            P.placement !== O &&
                            n.setState({ currentPlacement: P.placement });
                        },
                      });
                    }
                    if (o) {
                ...
                },
                {
                  ...
                  get: function () {
                    ...
                    if (a) {
                      var c;
                      [$.IDLE].indexOf(o) === -1 || [$.IDLE].indexOf(s) === -1
                        ? (c = l.wrapperPosition)
              ...
              V(this, 'beaconPopper'),
                ...
                V(this, 'setSteps', (i) => {
                  ...
                  this.data.set('steps', i),
                    a === Q.WAITING && !o && i.length && (s.status = Q.RUNNING),
                    this.setState(s);
                }),
                V(this, 'getPopper', (i) =>
                ...
                V(this, 'go', (i) => {
                  ...
                  this.setState({
                    ...this.getNextState({ action: ee.GO, index: i }),
                    status: s ? a : Q.FINISHED,
                  });
                }),
                ...
                V(this, 'prev', () => {
                  ...
                  o === Q.RUNNING &&
                    this.setState({
                      ...this.getNextState({ action: ee.PREV, index: i - 1 }),
                    });
                }),
                V(this, 'reset', (i = !1) => {
                  ...
                  o ||
                    this.setState({
                      ...this.getNextState({ action: ee.RESET, index: 0 }),
          ...
          constructor(e, t) {
            if (
              ...
              V(this, 'canHaveFocus', (r) => {
                ...
                return (
                  ((n.test(i) && !r.getAttribute('disabled')) ||
                    (i === 'a' && !!r.getAttribute('href'))) &&
                  this.isVisible(r)
                );
              }),
              ...
              V(this, 'isHidden', (r) => {
                ...
                return n && !r.innerHTML
                  ? !0
                  : (n && i.getPropertyValue('overflow') !== 'visible') ||
        ...
        (dd = pd),
          (hd = class extends nt {
            ...
            render() {
              ...
              let u = s.overlay;
              Gi() &&
                (u = a === 'center' ? s.overlayLegacyCenter : s.overlayLegacy);
              let l = {
                ...
                c =
                  a !== 'center' &&
                  t &&
                  J(dd, { styles: this.spotlightStyles });
              if (Ws() === 'safari') {
        ...
        (vd = yd),
          ...
          (xd = class extends nt {
                ...
                V(this, 'setPopper', (e, t) => {
                  ...
                  t === 'wrapper'
                    ...
                    a.getPopper('beacon') &&
                      a.getPopper('tooltip') &&
                      i === X.INIT &&
                      a.update({ action: n, lifecycle: X.READY }),
                    (r = o.floaterProps) != null &&
                      r.getPopper &&
            ...
            componentDidUpdate(e) {
              ...
              f('lifecycle', X.INIT, X.READY) &&
                d.update({ lifecycle: Yi(p) || S ? X.TOOLTIP : X.BEACON }),
                h('index') &&
                  dt({
                    title: `step:${l}`,
                    data: [{ key: 'props', value: this.props }],
                ...
                h('lifecycle', X.BEACON) &&
                  n({ ...v, step: p, type: Ve.BEACON }),
                h('lifecycle', X.TOOLTIP) &&
                  (n({ ...v, step: p, type: Ve.TOOLTIP }),
                  this.tooltip &&
                    ((this.scope = new ud(this.tooltip, {
          ...
          (Xs = class extends nt {
            constructor(e) {
              ...
              (this.store = ld({ ...e, controlled: n && N.number(i) })),
            ...
            componentDidUpdate(e, t) {
              ...
              if (
                (W &&
                  (Ki(c, s) ? f(c) : console.warn('Steps are not valid', c)),
                b('run') && (u ? v(l) : S()),
                B)
              ) {
              ...
              if (
                y('action', [ee.NEXT, ee.PREV, ee.SKIP, ee.CLOSE]) &&
                y('status', Q.PAUSED)
              ) {
              ...
              if (y('status', [Q.FINISHED, Q.SKIPPED])) {
                ...
                P('status', [Q.IDLE, Q.READY], Q.RUNNING)
                  ...
                  : (y('status') || y('action', ee.RESET)) &&
                    this.callback({ ...H, type: Ve.TOUR_STATUS });
              this.scrollToStep(t),
                O.placement === 'center' &&
                  a === Q.RUNNING &&
                  o === X.INIT &&
...
`;
        ...
        (ea = {
          ...
          (mr = {});
        for (let e in ea)
          mr[e] = { isEnabled: (t) => ea[e].some((r) => !!t[r]) };
        (nl = ot({})),
          (ol = ot({})),
          (Sh = Symbol.for('motionComponentSymbol'));
        Ah = [
          'animate',
          'circle',
          'defs',
        ...
        (Gh = { offset: 'stroke-dashoffset', array: 'stroke-dasharray' }),
          (Xh = { offset: 'strokeDashoffset', array: 'strokeDasharray' });
        (pl = () => ({ ...jo(), attrs: {} })),
          (Vo = (e) => typeof e == 'string' && e.toLowerCase() === 'svg');
        hl = new Set([
          'baseFrequency',
          'diffuseConstant',
          'kernelMatrix',
            ...
            super(...arguments),
                ...
                let r = this.node.getProps(),
                  n = Ze(
                    ...
                    (o, a) => {
                      ...
                      le.update(() => {
                        !l && !wl(this.node.current, o.target)
                          ? u && u(o, a)
                          : s && s(o, a);
                      });
                    },
              ...
              (this.startAccessiblePress = () => {
                let e = (i) => {
                  ...
                  r = () => {
                    this.isPressing &&
                      zn('cancel', (i, o) => this.cancelPress(i, o));
                  },
        ...
        (gf = { some: 0, all: 1 }),
          (yf = class extends gt {
            ...
            startObserver() {
              ...
              let { viewport: e = {} } = this.node.getProps(),
                ...
                o = {
                  ...
                  rootMargin: r,
                  threshold: typeof n == 'number' ? n : gf[n],
                },
                a = (s) => {
                  ...
                  let { onViewportEnter: l, onViewportLeave: c } =
                      this.node.getProps(),
                    p = u ? l : c;
                  p && p(s);
                };
            ...
            update() {
              ...
              ['amount', 'margin', 'root'].some(vf(e, t)) &&
                this.startObserver();
            }
            unmount() {}
          });
        ...
        (ct = (e) => e * 1e3),
          (et = (e) => e / 1e3),
          (Tf = { current: !1 }),
          (El = (e) => Array.isArray(e) && typeof e[0] == 'number');
        ...
        (Af = Rr(0.42, 0, 1, 1)),
          ...
          (la = (e) => {
            if (Array.isArray(e)) {
              ...
              return Fe(sa[e] !== void 0, `Invalid easing type '${e}'`), sa[e];
            return e;
          }),
          (gr = (e, t, r) => {
            let n = t - e;
        ...
        (ca = (e, t) => {
          ...
          (xe = {
            ...
            parse: (e) =>
              St.test(e) ? St.parse(e) : Dt.test(e) ? Dt.parse(e) : oo.parse(e),
            transform: (e) =>
              Or(e)
                ? e
        ...
        (Pt = {
          ...
          (pm = (e) => {
            ...
            return {
              start: () => le.update(t, !0),
              stop: () => tt(t),
              now: () => (ve.isProcessing ? ve.timestamp : Pt.now()),
            };
          });
        ...
        (mm = fm(() =>
          ...
          (ym = 2e4),
          (vm = (e, t) =>
            t.type === 'spring' || e === 'backgroundColor' || !Sl(t.ease));
            ...
            if (
              ...
              (this.updatePoint = () => {
                ...
                p ||
                  ...
                  S && S(this.lastMoveEvent, c);
              }),
              (this.handlePointerMove = (c, p) => {
                (this.lastMoveEvent = c),
                  (this.lastMoveEventInfo = Yn(p, this.transformPagePoint)),
        ...
        (tu = ({ current: e }) => (e ? e.ownerDocument.defaultView : null)),
          ...
          (wg = class {
            ...
            start(e, { snapToCursor: t = !1 } = {}) {
              ...
              let n = (l) => {
                  ...
                  c ? this.pauseAnimation() : this.stopAnimation(),
                    t && this.snapToCursor(yn(l, 'page').point);
                },
                i = (l, c) => {
                  let {
                    drag: p,
                ...
                s = () =>
                  Le((l) => {
                    ...
                    return (
                      ...
                      ((c = this.getAxisMotionValue(l).animation) === null ||
                      c === void 0
                        ? void 0
                        : c.play())
                    );
            ...
            updateAxis(e, t, r) {
              ...
              this.constraints &&
                this.constraints[e] &&
                (o = lg(o, this.constraints[e], this.elastic[e])),
                i.set(o);
            }
            resolveConstraints() {
              var e;
        ...
        (ar = {
          ...
          (Og = {
            correct: (e, { treeScale: t, projectionDelta: r }) => {
              ...
              let l = se(s, u, 0.5);
              return (
                typeof i[2 + a] == 'number' && (i[2 + a] /= l),
                typeof i[3 + a] == 'number' && (i[3 + a] /= l),
                o(i)
              );
            },
          }),
          (Cg = class extends m.Component {
            ...
            getSnapshotBeforeUpdate(e) {
              ...
              return (
                o &&
                  ((o.isPresent = i),
                  n || e.layoutDependency !== t || t === void 0
                    ? o.willUpdate()
                    : this.safeToRemove(),
                  e.isPresent !== i &&
                    (i
        ...
        (Fg = (e, t) => e.depth - t.depth),
          (Bg = class {
            ...
            forEach(e) {
              this.isDirty && this.children.sort(Fg),
                (this.isDirty = !1),
        ...
        (sy = su({
          ...
          (ly = {
            pan: { Feature: Sg },
            drag: { Feature: Eg, ProjectionNode: uu, MeasureLayout: ru },
          }),
          ...
          (Oy = class {
            ...
            getValue(e, t) {
              ...
              return (
                r === void 0 &&
                  t !== void 0 &&
                  ((r = Bt(t, { owner: this })), this.addValue(e, r)),
                r
              );
            }
            readValue(e) {
        ...
        (Ay = class extends hu {
          ...
          (Iy = (e, t) =>
            Mo(e)
              ? new Ry(t, { enableHardwareAcceleration: !1 })
          ...
          (zy = ({ activeStep: e, data: t, width: r, filename: n }) => {
            let [i, o] = Pe([]),
              ...
              s = (c) => {
                let p = 0;
                for (let d = 0; d < c; d++)
                  p -= a[d].current.getBoundingClientRect().height;
                return p;
              },
              u = Rt(() => {
                let c = t.flatMap((p, d) => {
          ...
          (Qn = ({ children: e, index: t, isCompleted: r }) =>
            m.createElement(
              ...
              m.createElement(
                qy,
                {
                  'aria-label': r ? 'complete' : 'not complete',
                  isCompleted: r,
                },
                r
                  ? m.createElement(yi, {
